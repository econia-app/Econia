              ...
              {(answers.statut === "salarie" || answers.statut === "cumul" || answers.enfants !== "0" || answers.sap !== "non") && (
                <div style={{ marginBottom: "20px" }}>
                  <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "10px" }}>
                    ...
                    <h3 style={{ fontSize: "13px", fontWeight: 700, color: T.textSoft, textTransform: "uppercase" as const, letterSpacing: "0.8px", fontFamily: fontSub }}>Déclaration d&apos;impôts personnalisée</h3>
                  </div>
